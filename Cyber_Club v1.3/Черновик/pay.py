...
# Form implementation generated from reading ui file 'C:\Users\Александр\Desktop\Cyber_Club1\UI\pay.ui'
#
...
class Ui_PayWindow(object):
    def setupUi(self, PayWindow):
        ...
        PayWindow.resize(450, 750)
        PayWindow.setMinimumSize(QtCore.QSize(450, 750))
        PayWindow.setMaximumSize(QtCore.QSize(450, 750))
...
"border-radius: 10px;")
        ...
        self.gridLayout.addWidget(self.input_email_2, 17, 0, 1, 1)
...
"border-radius: 10px;")
        ...
        self.gridLayout.addWidget(self.text_email_2, 16, 0, 1, 1)
...
######################### Кнопка оплатить ######################
        ...
        #self.btn_add.clicked.connect(self.chek)
...
######################## БД ########################################
    ...
    def insert_pay(self):
        ...
        ####### ЗАПОЛНЕНИЕ
            ...
            par8.add_run("№ ПК - " + id_pc)
            par9.add_run("АРЕНДА ПК НА " + time)
            par10.add_run('= ' + sum)
            par11.add_run('______________________')
            par12.add_run('ИТОГ').bold=True
            par13.add_run("       " + sum +"RUB").bold=True
            par14.add_run("НАЛИЧ/КАРТОЙ     = " + sum + "RUB")
            par15.add_run('***********************')
...
###########################################################################
    ...
    def retranslateUi(self, PayWindow):
        ...
        self.input_phone.setPlaceholderText(_translate("PayWindow", "11.11.2000"))
        self.text_phone.setText(_translate("PayWindow", "Дата"))
