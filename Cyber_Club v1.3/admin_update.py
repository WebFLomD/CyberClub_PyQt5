...
# Form implementation generated from reading ui file 'UI\admin_update.ui'
#
...
class Ui_AdminWindow(object):
    def setupUi(self, AdminWindow):
        ...
        AdminWindow.resize(450, 850)
        AdminWindow.setMinimumSize(QtCore.QSize(450, 850))
        AdminWindow.setMaximumSize(QtCore.QSize(450, 850))
...
"border-radius: 10px;")
        ...
        self.gridLayout.addWidget(self.input_login, 16, 0, 1, 1)
...
"border-radius: 10px;")
        ...
        self.gridLayout.addWidget(self.input_login_3, 18, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.text_pass, 14, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.text_phone_2, 10, 0, 1, 1)
...
"border-radius: 10px;")
        ...
        self.gridLayout.addWidget(self.input_email_2, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.text_pass_2, 17, 0, 1, 1)
...
##############
        ...
        self.btn_add.clicked.connect(self.update_password)
...
#####################
    ...
    def update_fio(self):
        ...
        try:
            mycursor.execute("UPDATE admin SET fio='" + fio +"' WHERE id=" + id)
    ...
    def update_phone(self):
        ...
        try:
            mycursor.execute("UPDATE admin SET phone='" + phone +"' WHERE id=" + id)
            result = mycursor.fetchall
            mydb.commit()
    ...
    def update_data_born(self):
        id = self.input_fio_2.text()
        data_born = self.input_email_2.text()
        ...
        try:
            mycursor.execute("UPDATE admin SET data_born='" + data_born +"' WHERE id=" + id)
            result = mycursor.fetchall
            mydb.commit()
    ...
    def update_email(self):
        ...
        try:
            mycursor.execute("UPDATE admin SET email='" + email +"' WHERE id=" + id)
            result = mycursor.fetchall
            mydb.commit()
    ...
    def update_login(self):
        ...
        try:
            mycursor.execute("UPDATE admin SET login='" + login +"' WHERE id=" + id)
            result = mycursor.fetchall
            mydb.commit()
    ...
    def update_password(self):
        ...
        try:
            mycursor.execute("UPDATE admin SET password='" + password +"' WHERE id=" + id)
            result = mycursor.fetchall
            mydb.commit()

            self.label_2.setText("Успеешно изменено - Пароль")
...
#########################################################################################
    ...
    def retranslateUi(self, AdminWindow):
        ...
        AdminWindow.setWindowTitle(_translate("AdminWindow", "Редактор администратора"))
        self.label.setText(_translate("AdminWindow", "Редактор администратора"))
        ...
        self.input_fio_2.setPlaceholderText(_translate("AdminWindow", "ID"))
        self.text_login_2.setText(_translate("AdminWindow", "ID"))
        self.btn_add.setText(_translate("AdminWindow", "Сохранить"))
